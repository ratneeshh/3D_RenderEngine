...
public class Render extends JPanel {
    ...
    Render() {
        ...
        Vertex top = new Vertex(0, 100, 0);      // Top point
        Vertex bottom = new Vertex(0, -100, 0);  // Bottom point

            // Middle vertices (forming the central square/middle points)
        Vertex front = new Vertex(0, 0, 70);     // Front point
        Vertex back = new Vertex(0, 0, -70);     // Back point
        Vertex right = new Vertex(70, 0, 0);     // Right point
        Vertex left = new Vertex(-70, 0, 0);     // Left point
        ...
        tris.add(new Triangle(top, left, front, Color.YELLOW));
            ...
            // Lower pyramid faces
        tris.add(new Triangle(bottom, right, front, Color.MAGENTA));
        tris.add(new Triangle(bottom, back, right, Color.CYAN));
        tris.add(new Triangle(bottom, left, back, Color.ORANGE));
        tris.add(new Triangle(bottom, front, left, Color.PINK));;
    }
